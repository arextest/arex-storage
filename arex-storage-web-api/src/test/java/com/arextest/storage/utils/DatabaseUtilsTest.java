...
//import com.arextest.storage.utils.SqlParseUtils;
...
//        TableSchema tableSchema = sqlParseManager.parse(sql);
...
//                "\n";
//        Map<String, String> stringStringMap = sqlParseManager.parse(sql);
//        assertEquals(DbParseConstants.SELECT, stringStringMap.get("action"));
...
//        for (String s : split) {
//            Map<String, String> tableAndAction = sqlParseManager.parse(s);
...
//                "   );";
//
//        Map<String, String> tableAndAction = sqlParseManager.parse(sql);
