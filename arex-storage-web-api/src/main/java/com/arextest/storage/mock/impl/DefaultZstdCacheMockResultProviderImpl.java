...
import com.arextest.storage.mock.MockKeyBuilder;
...
final class DefaultZstdCacheMockResultProviderImpl implements MockResultProvider {
     ...
     */
    @Override
    public byte[] getRecordResult(MockCategoryType category, @NotNull MockItem mockItem, MockResultContext context) {
    ...
    private byte[] getRecordResult(MockCategoryType category, final byte[] recordIdBytes, byte[] replayIdBytes,
        ...
        try {
            ...
            boolean tryFindLastValue = MockStrategy.TRY_FIND_LAST_VALUE == context.getMockStrategy();
