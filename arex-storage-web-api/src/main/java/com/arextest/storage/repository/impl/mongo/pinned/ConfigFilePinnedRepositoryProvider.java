...
@Repository
final class ConfigFilePinnedRepositoryProvider extends AbstractPinnedRepositoryProvider<ConfigFileMocker> {
    private static final String CONFIG_KEY_COLUMN_NAME = "key";

    public ConfigFilePinnedRepositoryProvider(MongoDatabase mongoDatabase) {
        super(mongoDatabase);
    }
