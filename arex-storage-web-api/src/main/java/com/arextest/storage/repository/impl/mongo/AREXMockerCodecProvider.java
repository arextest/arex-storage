...
final class AREXMockerCodecProvider implements CodecProvider {
    private final Codec<?> targetCodec = new CompressionCodecImpl<>(Mocker.Target.class);
    ...
    private Codec customCodecLookup(PropertyModelBuilder<?> propertyModelBuilder) {
        ...
        if (DefaultMongoRepositoryProvider.CREATE_TIME_COLUMN_NAME.equals(propertyModelBuilder.getName())) {
