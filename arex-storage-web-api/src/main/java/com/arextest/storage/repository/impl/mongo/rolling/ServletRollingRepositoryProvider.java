 ...
 */
@Repository
public class ServletRollingRepositoryProvider extends AbstractRollingRepositoryProvider<ServletMocker> {
    private static final String PATTERN_COLUMN_NAME = "pattern";

    public ServletRollingRepositoryProvider(MongoDatabase mongoDatabase) {
        super(mongoDatabase);
    }
