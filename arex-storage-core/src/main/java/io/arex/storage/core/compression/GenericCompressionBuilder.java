package io.arex.storage.core.compression;
 ...
 */
@Slf4j
public final class GenericCompressionBuilder<T extends MockItem> {
    public static final GenericCompressionBuilder<? extends MockItem> DEFAULT = new GenericCompressionBuilder<>();
